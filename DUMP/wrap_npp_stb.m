function struct_out = wrap_npp_stb(struct_in,names_data,n_permutes,time_window,plotting_input)
...
for i = 1:n_datasets
    ...
    for j = 1:n_chans
        ...
        [zmap_c, zmapthresh_c, zmapthresh_plc_c, zmapthresh_clc_c, ~] = npp_stb(data_chan,n_permutes,v_time,v_freq,time_window,plotting_input,my_title);
        temp.zmap(j,:,:) = zmap_c;
