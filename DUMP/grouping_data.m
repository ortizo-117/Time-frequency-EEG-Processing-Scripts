function struct_out = grouping_data(pathname,area_to_subset,timepoint)

% Groups all gamma data in the folder in one condition


 file_struct_list = dir([pathname filesep() '*.mat']);  %% get list of .set files in the pathname specified
