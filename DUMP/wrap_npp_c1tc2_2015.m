function struct_out = wrap_npp_c1tc2_2015(struct_in1,struct_in2,names_data,n_permutes,time_window,plotting_input)
...
for i = 1:n_datasets
    ...
    for j = 1:n_chans_1
        ...
        [zmap_c, zmapthresh_c, zmapthresh_plc_c, zmapthresh_clc_c,...
            tfv_time_c, ~] = npp_c1tc2_2015(data_chan_1,data_chan_2,n_permutes,v_time,v_freq,time_window,plotting_input,my_title);
