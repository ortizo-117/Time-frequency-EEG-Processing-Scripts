function [zmap, zmapthresh, zmapthresh_plc, zmapthresh_clc, tfv_time, v_freq] = npp_c1tc2_2015(input_mat1,input_mat2,n_permutes,v_time,v_freq,time_window,plotting_input,my_title)
%% Description:
