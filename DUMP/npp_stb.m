function [zmap, zmapthresh, zmapthresh_plc, zmapthresh_clc, tfv_time, v_freq] = npp_stb(input_mat,n_permutes,v_time,v_freq,time_window,plotting_input,my_title)
%% Description:
...
%% getting zmaps
if mean(mean(isnan(t_mat))) == 1
    zmap = zeros(size(t_mat));
else
